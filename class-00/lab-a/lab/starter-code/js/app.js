...
function displayPics(){
  ...
  // The previous line of code threw an error when we changed the variable declaration from var to let because it changed rando to be within local scope. rando was attempting to be invoked outside the new scope. 
  console.log(viewed);
